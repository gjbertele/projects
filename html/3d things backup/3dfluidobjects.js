...
const projectTo3D = (x, y, z) => {
    ...
    //rotatedZ = (x - wwtdh) * xAxis.y + (z - wwtdh) * yAxis.y - cameraPos.z
    //size = 1 + fovInv * (x - wwtdh) * xAxis.y + fovInv * (z - wwtdh) * yAxis.y - fovInv * cameraPos.z
    //Ex*size = ix * xAxis.x + iz * yAxis.x - cameraPos.x
    //Ey*size = yC - cameraPos.y
    //Ey - Ey*fovInv*yAxis.y *wwtdh - Ey*fovInv * cameraPos.z + cameraPos.y - constY - Ey*xAxis.y*fovInvwwtdh = - Ey*xAxis.y*fovInv *x-Ey*fovInv*yAxis.y * z
    //Ex - Ex*xAxis.y*fovInv*wwtdh + Ex*fovInv*yAxis.y*z - Ex*fovInv*yAxis.ywwtdh - Ex*fovInv * cameraPos.z + cameraPos.x + wwtdh*xAxis.x + whtdh * yAxis.x = x*xAxis.x + z*yAxis.x
